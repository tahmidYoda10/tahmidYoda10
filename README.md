...
<p align="center">
  ...
  Engineering the Future, clean-architected products - from idea to deployment.
</p>
...
<div align="center">
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=java,spring,kotlin,flutter,postgres,mysql,redis,mongodb&perline=9&theme=dark" alt="Tech Stack" />
  </a>
</div>
...
> *In the memory of great revolutionary Shaheed Sharif Osman Gani Bin Hadi.* > `Spring Boot` `MongoDB` `Clean Architecture`
...
> *Seamless experience platform, designed and deployed end-to-end with a focus on usability.* > `Springboot` `REST API` `JWT`
...
> *Regional knowledge app for Sylhet — offline-ready, fast, and highly user-friendly.* > `Kotlin` `Android` `MySQL`
...
> *A new mobile product currently in active development. Stay tuned for the official release.* > `Mobile App & Web` `In Progress`
